...
iter_with_delay = Factory(name="iter with delay",
                          ...
                          inputs=(
                              dict(name="generator", interface=None,
                                   value=None),
...
whileuni = Factory(name="while univariate",
                   ...
                   inputs=(dict(name="InitValue", interface=None, value=None),
                           ...
                           dict(name="Function", interface=IFunction,
                                value=None),
                           ),
...
whilemulti = Factory(name="while multivariate",
                     ...
                     inputs=(
                         dict(name="InitValues", interface=ISequence, value=[]),
                         dict(name="Test", interface=IFunction, value=None),
...
whilemulti2 = Factory(name="while multivariate2",
                      ...
                      inputs=(
                          dict(name="InitValues", interface=ISequence,
                               value=[]),
                          dict(name="Test", interface=IFunction, value=None),
                          dict(name="Functions", interface=IFunction,
                               value=None),
...
cmd = Factory(name=protect("command"),
